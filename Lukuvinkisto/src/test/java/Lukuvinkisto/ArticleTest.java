...
public class ArticleTest {
    ...
    public void SortsCorrectly() {
        ...
        articles.add(new Article("Linnunradan kasikirja liftareille", "https://fi.wikipedia.org/wiki/Linnunradan_k%C3%A4sikirja_liftareille", List.of("ef", "gh")));
        Collections.sort(articles);
        assertEquals(articles.get(0).toString(), "Linnunradan kasikirja liftareille : https://fi.wikipedia.org/wiki/Linnunradan_k%C3%A4sikirja_liftareille, Tagit: ef, gh; Lukematta");
    }
    
    @Test
    public void ReturnCorrectListElement() {
        Article article = new Article(1,"Wikipedia: The Hitchhiker's Guide to the Galaxy", "https://en.wikipedia.org/wiki/The_Hitchhiker%27s_Guide_to_the_Galaxy", List.of("ab", "cd"),0);
        assertEquals(article.getAsListElement(), "<a href=\"https://en.wikipedia.org/wiki/The_Hitchhiker%27s_Guide_to_the_Galaxy\">Wikipedia: The Hitchhiker's Guide to the Galaxy<a>, Tagit: ab, cd; Lukematta <form method=\"GET\" action=\"/artikkeli/1\">\n" +
