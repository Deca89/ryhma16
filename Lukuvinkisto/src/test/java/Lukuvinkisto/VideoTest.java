...
public class VideoTest {
    ...
    public void SortsCorrectly() {
        ...
        assertEquals(videos.get(0).toString(), "Stephen Moore reads The Hitch-Hiker's Guide to the Galaxy by Douglas Adams : https://youtu.be/dPbr0v_V-cI, Tagit: ab, cd; Katsomatta");
    }
    @Test
