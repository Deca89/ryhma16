...
public class VideoTest {
    ...
    public void ReturnCorrectListElement() {
        ...
        assertEquals(video.getAsListElement(), "<a href=\"https://youtu.be/dPbr0v_V-cI\">Stephen Moore reads The Hitch-Hiker's Guide to the Galaxy by Douglas Adams<a>, Tagit: ab, cd; Katsottu <form method=\"GET\" action=\"/video/1\">\n" +
