...
public class Stepdefs {
    ...
    public void demodbAdded() {
        ...
        article = new Article("Linnunradan kasikirja liftareille", "https://fi.wikipedia.org/wiki/Linnunradan_k%C3%A4sikirja_liftareille", List.of("wikipedia", "liftausta"));
        instance.addArticle(article.getTitle(), article.getLink(), article.getTags());
        ...
        video = new Video("The Hitchhiker's Guide to the Galaxy read by Douglas Adams [Part 1 of 4]", "https://youtu.be/FmakHVY7xeU", List.of("Aanikirja", "englanti", "osa1","liftausta"));
        instance.addVideo(video.getTitle(), video.getLink(), video.getTags());

        Book book = new Book("Linnunradan kasikirja liftareille", "Adams, Douglas", 203, List.of("osa1", "liftausta"));
