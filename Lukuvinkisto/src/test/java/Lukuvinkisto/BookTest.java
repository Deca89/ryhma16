...
public class BookTest {
    ...
    public void ReturnCorrectAuthor() {
        ...
        Book book = new Book("Linnunradan k‰sikirja liftareille", "Adams, Douglas", 203, tags);
    ...
    public void ReturnCorrectTitle() {
        List<String> tags = List.of("ab", "cd");
        Book book = new Book("Linnunradan k‰sikirja liftareille", "Adams, Douglas", 203, tags);
        assertEquals(book.getTitle(), "Linnunradan k‰sikirja liftareille");
    }
    ...
    public void ReturnCorrectListElement() {
        Book book = new Book("Linnunradan k‰sikirja liftareille", "Adams, Douglas", 203, List.of("ab", "cd"));
