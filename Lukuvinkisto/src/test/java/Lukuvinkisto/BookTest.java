...
public class BookTest {
    ...
    public void ReturnCorrectAuthor() {
        ...
        Book book = new Book("Linnunradan kasikirja liftareille", "Adams, Douglas", 203, tags);
    ...
    public void ReturnCorrectTitle() {
        List<String> tags = List.of("ab", "cd");
        Book book = new Book("Linnunradan kasikirja liftareille", "Adams, Douglas", 203, tags);
        assertEquals(book.getTitle(), "Linnunradan kasikirja liftareille");
    }
    ...
    public void SortsCorrectly() {
        ...
        books.add(new Book("Linnunradan kasikirja liftareille", "Adams, Douglas", 203, tags1));
        books.add(new Book("Maailmanlopun ravintola", "Adams, Douglas", 222, tags2));
        Collections.sort(books);
        assertEquals(books.get(0).toString(), "Adams, Douglas : Linnunradan kasikirja liftareille, sivumaara: 203, luettu: 0/203, Tagit: ab, cd");
    }
    @Test
    public void ReturnCorrectListElement() {
        Book book = new Book("Linnunradan kasikirja liftareille", "Adams, Douglas", 203, List.of("ab", "cd"));
